...
I.prototype.round=function(){this.l=Math.round(this.l);this.o=Math.round(this.o);return this};var kc=F("Opera"),J=F("Trident")||F("MSIE"),lc=F("Edge"),mc=F("Gecko")&&!(-1!=E.toLowerCase().indexOf("webkit")&&!F("Edge"))&&!(F("Trident")||F("MSIE"))&&!F("Edge"),nc=-1!=E.toLowerCase().indexOf("webkit")&&!F("Edge"),oc=F("Macintosh"),pc=F("Windows"),qc=F("Android"),rc=Hb(),sc=F("iPad"),tc=F("iPod");function vc(){var a=n.document;return a?a.documentMode:void 0}
var wc;a:{var xc="",yc=function(){var a=E;if(mc)return/rv\:([^\);]+)(\)|;)/.exec(a);if(lc)return/Edge\/([\d\.]+)/.exec(a);if(J)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(nc)return/WebKit\/(\S+)/.exec(a);if(kc)return/(?:Version)[ \/]?(\S+)/.exec(a)}();
yc&&(xc=yc?yc[1]:"");if(J){var zc=vc();if(null!=zc&&zc>parseFloat(xc)){wc=String(zc);break a}}wc=xc}var Ac=wc,Ua={};
...
var Bc;var Cc=n.document;Bc=Cc&&J?vc()||("CSS1Compat"==Cc.compatMode?parseInt(Ac,10):5):void 0;function Dc(a,b){Ec||Fc();Gc||(Ec(),Gc=!0);var c=Hc,d=Gb.get();d.set(a,b);c.f?c.f.next=d:c.b=d;c.f=d}
...
var Jd=r("yt.pubsub.skipSubId_")||null;q("yt.pubsub.skipSubId_",Jd,void 0);function Ld(a,b,c){var d=Md();if(d){var e=d.subscribe(a,function(){if(!Jd||Jd!=e){var d=arguments,g;g=function(){Gd[e]&&b.apply(c||window,d)};
...
function de(a,b){var c=ee(a),d=document.getElementById(c),e=d&&C(d,"loaded"),f=d&&!e;if(e)b&&b();else{if(b){var e=Ld(c,b),g=""+ia(b);fe[g]=e}f||(d=ge(a,c,function(){C(d,"loaded")||(gb(d,"loaded","true"),Od(c),B(na(Qd,c),0))}))}}
...
function Kf(a,b,c){function d(a,b){if(da)return 0;Ae.clearTimeout(u);ob.push.apply(ob,ha);var d=((He||{}).config||{}).update;d?d(f):f&&N(P,"cu",[]).push(f);if(b){bf("me0",a,uc);try{Hf(b,c,m)}finally{bf("me1",a,uc)}}return 1}
a=Ge(a)||[];var e=b.callback,f=b.config,g=b.timeout,k=b.ontimeout,h=b.onerror,m=void 0;"function"==typeof h&&(m=h);var u=null,da=!1;if(g&&!k||!g&&k)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var h=N(Ue(c),"r",[]).sort(),ob=N(Ue(c),"L",[]).sort(),uc=[].concat(h);0<g&&(u=Ae.setTimeout(function(){da=!0;k()},g));
...
if(!a)return 0;bf("ml1",ha,uc);0<Ca&&Ba[Ca-1]?Ba[Ca]=function(){c(b)}:c(b)};
if(ha.length){var Kd="loaded_"+P.I++;He[Kd]=function(a){Ba[Ca](a);He[Kd]=null};
a=rf(c,ha,"gapi."+Kd,h);h.push.apply(h,ha);bf("ml0",ha,uc);b.sync||Ae.___gapisync?Ef(a):Ff(a)}else Ba[Ca](De)}else d(ha)&&e&&e()}
...
var ig,jg=new Of;ig=jg.isAvailable()?new Lf(jg):null;var hg,kg=new Pf;hg=kg.isAvailable()?new Lf(kg):null;function lg(a,b,c){var d=mg,e={};e.eventTimeMs=Math.round(c||eb());e[a]=b;dg({endpoint:"log_event",Oa:e},d)}
...
function Qh(a,b){if(!b&&"_"!=a[0]){var c=a;Ch.mark&&(0==c.lastIndexOf("mark_",0)||(c="mark_"+c),Ch.mark(c))}var c=Rh(),d=b||eb();c[a]&&(c["_"+a]=c["_"+a]||[c[a]],c["_"+a].push(d));c[a]=d;(Sh()["tick_"+a]=b)||eb();Pe("csi_on_gel")?(c=Th(),"_start"==a?lg("latencyActionBaselined",{clientActionNonce:c},b):lg("latencyActionTicked",{tickName:a,clientActionNonce:c},b),c=!0):c=!1;if(c=!c)c=!r("yt.timing.pingSent_");if(c&&(d=A("TIMING_ACTION",void 0),c=Rh(),r("yt.timing.ready_")&&d&&c._start&&Uh())){var d=
!0,e=A("TIMING_WAIT",[]);if(e.length)for(var f=0,g=e.length;f<g;++f)if(!(e[f]in c)){d=!1;break}d&&Vh()}}
function Wh(){var a=Xh().info.yt_lt="hot_bg";Sh().info_yt_lt=a;if(Pe("csi_on_gel"))if("yt_lt"in Nh){var b={},c=Nh.yt_lt;xb(Oh,c)&&(a=!!a);b[c]=a;a=Th();b.clientActionNonce=a;lg("latencyActionInfo",b)}else db(Error("Unknown label yt_lt logged with GEL CSI."))}
...
;var gl=null,hl=null,il=null,jl={};function kl(a){var b=a.id;a=a.ve_type;var c=Me++;a=new Le(void 0,a,c);jl[b]=a;b=Cg();c=Bg();b&&c&&wg(b,c,a)}
function ll(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(z("client-screen-nonce",b),z("ROOT_VE_TYPE",a),a=Bg()))for(var c in jl)wg(b,a,jl[c])}
function ml(a){jl[a.id]=new Le(a.tracking_params)}
function nl(a){var b=Cg();a=jl[a.id];b&&a&&xg(yg(),{click:{csn:b,visualElement:Ne(a)}},void 0)}
function ol(a){a=a.ids;var b=Cg();if(b){for(var c=[],d=0;d<a.length;d++){var e=jl[a[d]];e&&c.push(e)}c.length&&zg(b,c)}}
function pl(){var a=gl.startInteractionLogging;a&&a()}
...
pb(il,hl);if(a=gl)a.removeEventListener("onScreenChanged",ll),a.removeEventListener("onLogClientVeCreated",kl),a.removeEventListener("onLogServerVeCreated",ml),a.removeEventListener("onLogVeClicked",nl),a.removeEventListener("onLogVesShown",ol),a.removeEventListener("onReady",pl),a.destroy();jl={}});
window.addEventListener?(window.addEventListener("load",ql),window.addEventListener("unload",rl)):window.attachEvent&&(window.attachEvent("onload",ql),window.attachEvent("onunload",rl));var sl=wj.getInstance(),tl=X(sl);tl in Bj||(sl.register(),sl.ka.push(Ld("yt-uix-init-"+tl,sl.init,sl)),sl.ka.push(Ld("yt-uix-dispose-"+tl,sl.dispose,sl)),Bj[tl]=sl);}).call(this);
